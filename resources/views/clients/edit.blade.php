...
<body>
    ...
    <div class="f">
        <form action="edit.php" method="post">
            ...
            <div class="in">
                <label for="f">
                    <input type="email" name="email" id="f" placeholder="email" required>
                </label>
            </div>
            <div class="in">
                <label for="p">
                    <input type="tel" name="phone_number" id="p" placeholder="phone number"
                        required>
                </label>
            </div>
            <div class="in">
                <label for="c">
                    <input type="text" name="full_address" id="c" placeholder="full address"
                         required>
                </label>
            </div>
            <div class="for">
            ...
            <hr style="opacity:10%">
            <div class="b">
                <input type="submit" value="edit" class="s">
            </div>
        </form>
    </div>
</body>
