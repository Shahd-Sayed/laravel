...
<body>
    ...
    <div class='f' style='padding-top:20px'>
        <form action="/product" method='post' enctype='multipart/form-data' style='width:500px; height:540px; '>
            ...
            <div class='in'>
                <label for='p'>
                    <input type='text' name='size' id='p' placeholder='size' required>
                </label>
            </div>
            <div class='in'>
                <label for='c'>
            ...
            <!-- <div class='in'>
                <label for='c'>
                    <input type='file' name='image' id='c'  style='border-bottom:none'>
                </label>
            </div> -->
            <div class='for'>
